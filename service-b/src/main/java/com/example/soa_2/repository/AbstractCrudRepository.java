...
import com.example.soa_2.util.HibernateUtil;
...
public abstract class AbstractCrudRepository<ENTITY> {
    ...
    public List<ENTITY> findAll() {
        ...
        CriteriaQuery<ENTITY> criteriaQuery = criteriaBuilder.createQuery(this.type);
        Root<ENTITY> from = criteriaQuery.from(this.type);
